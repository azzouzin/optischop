...
class LightThemeColors {
  ...
  static const Color primaryColor = Color.fromARGB(255, 5, 4, 67);
  static const Color accentColor = Color.fromARGB(255, 178, 47, 208);
  ...
  static const Color backgroundColor = Color.fromARGB(255, 255, 242, 242);
  ...
  static const Color iconColor = Color.fromARGB(255, 168, 168, 168);
